  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9(data-aos="fade-left")
        .titulo-segundo
          h2 Un adecuado canto
        p.mb-4 Determinar los aspectos relacionados con el canto, con el fin de incluir en el desarrollo profesional o diario vivir, los factores influyentes en estos procesos. 
